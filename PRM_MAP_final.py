...
def majority_filter(lbl, size=3):
    # vote among labels 1..4, ignore 0
...
# -------------------------------------------------------
# 6) BUILD SEGMENTATION OVERLAY (4 classes) + SET COLORS
# -------------------------------------------------------
